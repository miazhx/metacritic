...
class MetaCriticSpider(Spider):
    ...
    def parse(self, response):
        result_urls = ['https://www.metacritic.com/browse/movies/score/metascore/all/filtered?page={}'.format(x) for x in range(0,1)]
    ...
    def parse_review_page(self, response):
        ...
        metascore, userscore = response.xpath('.//div[@class="score fl"]/a/div/text()').extract()  ### meta 
